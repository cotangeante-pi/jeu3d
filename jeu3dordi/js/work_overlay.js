...
const WorkOverlay = {
  _JOBS: {
    ...
    hotel: {
      title: '🏨 Réception de l\'hôtel',
      color: '#d4ac0d',
      payFactor: 0.42,
      rounds: [
        { icon: '🛎', label: 'Accueillir le client',      action: 'click'              },
        { icon: '🔑', label: 'Attribuer une chambre',      action: 'click'              },
        { icon: '🧹', label: 'Préparer la chambre (×3)',   action: 'multi', count: 3   },
        { icon: '😊', label: 'Vérifier la satisfaction',   action: 'hold',  duration: 3 },
        { icon: '💳', label: 'Encaisser le séjour',        action: 'click'              },
      ],
    },
    football: {
      ...
      payFactor: 0.38,
      rounds: [
        { icon: '🏃', label: 'S\'échauffer',               action: 'wait',  duration: 2 },
        { icon: '⚽', label: 'Dribbler les adversaires (×4)', action: 'multi', count: 4 },
        { icon: '🎯', label: 'Viser le but',               action: 'hold',  duration: 2 },
        { icon: '🥅', label: 'Tirer !',                    action: 'click'              },
        { icon: '🎉', label: 'Célébrer le but',            action: 'click'              },
      ],
    },
    farm: {
      title: '🌾 Travail à la ferme',
      color: '#8d6e63',
      payFactor: 0.35,
      rounds: [
        { icon: '🚜', label: 'Labourer la terre',          action: 'hold',  duration: 2.5 },
        { icon: '🌱', label: 'Semer les graines (×3)',     action: 'multi', count: 3      },
        { icon: '💧', label: 'Arroser les plants',         action: 'click'                },
        { icon: '☀️',  label: 'Laisser pousser…',          action: 'wait',  duration: 3   },
        { icon: '🧺', label: 'Récolter la culture (×3)',   action: 'multi', count: 3      },
        { icon: '💰', label: 'Vendre au marché',           action: 'click'                },
      ],
    },
  },
