const NPC = {
  DEFS: [
    ...
    {
      id: 'agence_immo', type: 'agence_immo', name: 'Agence Immobilière', x: 0, z: 70, dir: 1,
      house: { price: 500 }
    },
    {
      id: 'lv_shop', type: 'light_vehicle_shop', name: 'Boutique Mobilité Urbaine', x: -28, z: 42, dir: 1,
      vehicles: [
    ...
    {
      id: 'employer_farm', type: 'farm', name: 'Ferme du Coin', x: -42, z: 70, dir: 1,
      job: { id: 'farm', name: 'Fermier', salary: 18, iqRequired: 0, strengthRequired: 10, startHour: 6, endHour: 16 }
    },
    {
      id: 'employer_football', type: 'football', name: 'Stade de Football', x: -70, z: 28, dir: 1,
      job: { id: 'football', name: 'Footballeur', salary: 28, iqRequired: 0, strengthRequired: 20, startHour: 10, endHour: 20 }
    },
    {
      id: 'employer_hotel', type: 'hotel', name: 'Grand Hôtel', x: -42, z: 28, dir: 1,
      job: { id: 'hotel', name: 'Gestionnaire d\'hôtel', salary: 32, iqRequired: 20, strengthRequired: 0, startHour: 7, endHour: 22 }
    },
    {
      id: 'pompier_1', type: 'pompier', name: 'Caserne Nord', x: -28, z: 0, dir: 1,
      job: { id: 'pompier', name: 'Pompier', salary: 30, iqRequired: 0, strengthRequired: 10, startHour: 7, endHour: 20 }
    },
    {
      id: 'pompier_2', type: 'pompier', name: 'Caserne Est', x: 28, z: -70, dir: -1,
      job: { id: 'pompier', name: 'Pompier', salary: 30, iqRequired: 0, strengthRequired: 10, startHour: 7, endHour: 20 }
    },
    {
      id: 'pompier_3', type: 'pompier', name: 'Caserne Sud', x: -42, z: -42, dir: 1,
      job: { id: 'pompier', name: 'Pompier', salary: 30, iqRequired: 0, strengthRequired: 10, startHour: 7, endHour: 20 }
    },
  ],
  ...
  _palette: {
    ...
    hotel:          { wall: 0xfdf3e3, roof: 0xc0a060, floor: 0xeee8d5, sign: '#8b6914' },
    football:       { wall: 0x2e7d32, roof: 0x1b5e20, floor: 0x388e3c, sign: '#a5d6a7' },
    farm:              { wall: 0xd7a86e, roof: 0x8b4513, floor: 0xc8a45a, sign: '#5c2e00' },
    light_vehicle_shop:{ wall: 0xe8f8ff, roof: 0x0097a7, floor: 0xd0f0fa, sign: '#005f6e' },
    agence_immo:       { wall: 0xf0ece0, roof: 0x4a3728, floor: 0xe5e0d0, sign: '#2c1f10' },
  },
  ...
  _npcInside(scene, type, cx, npcZ) {
    const cols = { merchant: 0xff8800, school: 0x0066cc, employer: 0xddaa00, arena_athlete: 0x22dd44, car_race: 0xff3333, pompier: 0xff5500, hotel: 0xd4ac0d, football: 0x27ae60, farm: 0x8d6e63, light_vehicle_shop: 0x0097a7, agence_immo: 0x8b6914 };
