const NPC = {
  DEFS: [
    ...
    {
      id: 'agence_immo', type: 'agence_immo', name: 'Agence Immobilière', x: 56, z: 56, dir: 1,
      house: { price: 500 }
    },
    {
      id: 'lv_shop', type: 'light_vehicle_shop', name: 'Boutique Mobilité Urbaine', x: 14, z: 28, dir: 1,
      vehicles: [
    ...
    {
      id: 'employer_farm', type: 'farm', name: 'Ferme du Coin', x: -56, z: 28, dir: 1,
      job: { id: 'farm', name: 'Fermier', salary: 18, iqRequired: 0, strengthRequired: 10, startHour: 6, endHour: 16 }
    },
    {
      id: 'employer_football', type: 'football', name: 'Stade de Football', x: -56, z: 0, dir: 1,
  ...
  _npcInside(scene, type, cx, npcZ) {
    const cols = { merchant: 0xff8800, school: 0x0066cc, employer: 0xddaa00, arena_athlete: 0x22dd44, car_race: 0xff3333, hotel: 0xd4ac0d, football: 0x27ae60, farm: 0x8d6e63, light_vehicle_shop: 0x0097a7, agence_immo: 0x8b6914 };
